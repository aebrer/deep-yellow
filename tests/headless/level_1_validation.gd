...
func _validate_generators() -> void:
	...
	_check(level1.find("_carve_primary_channels") >= 0, "Level1Generator should carve channels")
	...
	_check(_contains("res://scripts/procedural/chunk_manager.gd", "if level_id == 1:"), "ChunkManager should skip Level 0 hallway cutting for Poolrooms")
